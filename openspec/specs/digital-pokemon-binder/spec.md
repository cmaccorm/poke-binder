...
The application MUST source card images and metadata from the catalog and MUST keep a local cache to make binder browsing and editing responsive. Cache writes MUST be batched into a single transaction per search operation for performance.
