...
- **AND** the primary accent color is red
...
- **AND** each binder card displays a thick light-colored border on the right edge (pages)
...
- **AND** the '+ New Binder' button is still accessible at the top